...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label>Gmail</label>
                <input type="text" name="gmail" class="form-control <?php echo (!empty($emailErr)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>">
            ...
            <div class="form-group">
                ...
                <input type="reset" class="btn btn-secondary ml-1" value="Reset">
            </div>
